          ...
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                ...
                >
                  <a :title="item.title" href="#" @click="searcOne(item.id,index)">{{item.title}}</a>
                </li>
              </ul>
            </dd>
          </dl>
...
export default {
  ...
  methods: {
    ...
    // 点击某个一级分类，查询出某个对应二级分类
    searcOne(subjectParentId, index) {
      // 把传递index的值赋值给oneIndex,为了active样式生效
      this.oneIndex = index;
      this.twoIndex = -1;
